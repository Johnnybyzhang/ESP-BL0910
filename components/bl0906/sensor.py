...
from . import BL0906Component

CONF_BL0906_ID = "bl0906_id"
CONF_TOTAL_POWER = "total_power"
CONF_TOTAL_ENERGY = "total_energy"

CHANNEL_KEYS = [f"channel_{i}" for i in range(1, 7)]
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(CONF_BL0906_ID): cv.use_id(BL0906Component),
...
async def to_code(config):
    hub = await cg.get_variable(config[CONF_BL0906_ID])
